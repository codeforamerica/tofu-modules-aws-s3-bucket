...
| malware_scanning | Malware scanning settings. Scanning is always enabled; `enabled` is not exposed. See below.      | `object` | `{}`         | no       |
...
| bucket_domain_name        | Domain name of the created bucket.                         | `string` |
